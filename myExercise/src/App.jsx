...
import Loginer from './Components/page/dangnhap';
import SignUpper from './Components/page/dangky';
...
function App() {
  ...
  return (
    <>
      ...
      <Navagation />
      <Routes>
        <Route path='signupper' element={<SignUpper />}></Route>
        <Route path='loginer' element={<Loginer />}></Route>
